...
const { handleCompanySignUP , handleCompanySignIN, handleCompanySignOUT, handleGetCompanyData, handleCompanyProfileUpdate, handleUploadProfilePicture, handleGetStudentDetails } = require('../controllers/company');
...
.put('/companyProfileUpdate' , isSignedIn("company") , handleCompanyProfileUpdate)
.post('/uploadProfilePicture' , isSignedIn("company") ,  uploadImg.single("profilePicture") , handleUploadProfilePicture)
