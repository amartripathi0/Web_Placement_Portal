              ...
              <div className="flex flex-col text-xl gap-5 w-1/3">
                <div className="bg-white p-3 flex flex-col gap-2">
                  <div className="flex gap-6 justify-between">
                    <h1>Placed:</h1>{" "}
                    <span className="font-medium">
                      {eachStudent.placementStatus.isPlaced && "Placed"}
                    </span>
                  </div>
                  <div className="flex gap-6 justify-between">
                    <h1>Company: </h1>
                    <span className="font-medium">
                      {eachStudent.placementStatus.companyName}
                    </span>
                  </div>
                  <div className="flex gap-6 justify-between">
                    <h1>Package Offered: </h1>
                    <span className="font-medium">
                      {eachStudent.placementStatus.packageOffered + "LPA"}
                    </span>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col gap-1 p-3">
                    ...
                    <ul className="font-medium ml-7 list-disc flex-col flex-wrap">
                      {eachStudent.pastInternshipsProjects.internships.map(
                        (intenship) => (
                          <li key={intenship.company + Math.random()}>
                            {intenship.company}
                          </li>
                        )
                      )}
                  ...
                  <div className="flex flex-col gap-1 p-3">
                    ...
                    <ul className="font-medium ml-7 list-disc">
                      {eachStudent.pastInternshipsProjects.projects.map(
                        (project) => (
                          <li key={project.title + eachStudent._id}>
                            {project.title}
                          </li>
                        )
                      )}
